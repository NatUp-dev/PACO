  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-md font-bold capitalize",
        nav: "flex items-center justify-end",
        nav_button: cn(
          buttonVariants({ variant: "ghost" }),
          "h-7 w-7 p-0 bg-blue-50"
        ),
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md w-9 font-normal text-xs capitalize",
        ...
        day: cn(
          buttonVariants({ variant: "ghost" }),
          "h-9 w-9 p-0 aria-selected:opacity-100 hover:cusor-pointer rounded-full"
        ),
